<div class="communicationLogs index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $communicationLog['CommunicationLog']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $communicationLog['CommunicationLog']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $communicationLog['CommunicationLog']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
