	...
	<div class="row">
		...
		<div class="col-md-12">
            ...
            <?php echo "<p class='btn btn-info'>Location details<p/>"; ?>
					<?php echo $this->Form->input('area', array('label' => 'Town / Township / Ward number / Location', 'type' => 'textarea', 'class' => 'form-control', 'placeholder' => 'Town/Township/Ward number/Location'));?>
				<?php echo "<br style='clear:both' />"; ?>
					<?php echo $this->Form->input('address', array('label' => 'Street Name', 'type' => 'textarea', 'class' => 'form-control', 'placeholder' => 'Street Name'));?>
				<?php echo "<br style='clear:both' />"; ?>
