	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Meeting Minutes'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading"><?php echo __('Actions'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Meeting Minute'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			...
			<?php echo $this->Html->link($meetingMinute['Meeting']['name'], array('controller' => 'meetings', 'action' => 'view', $meetingMinute['Meeting']['id'])); ?>
						...
						<td nowrap><?php echo h($meetingMinute['MeetingMinute']['document_name']); ?>&nbsp;</td>
						<td nowrap><?php echo h($meetingMinute['MeetingMinute']['created']); ?>&nbsp;</td>
						<td nowrap><?php echo h($meetingMinute['MeetingMinute']['uploaded)by']); ?>&nbsp;</td>
						<td class="actions">
